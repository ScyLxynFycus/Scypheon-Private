...
extern "C" {
    extern cl_int (CL_API_CALL *clGetPlatformIDs)(cl_uint, cl_platform_id *, cl_uint *);
    extern cl_int (CL_API_CALL *clGetPlatformInfo)(cl_platform_id, cl_platform_info, size_t, void *, size_t *);
    extern cl_int (CL_API_CALL *clGetDeviceIDs)(cl_platform_id, cl_device_type, cl_uint, cl_device_id *, cl_uint *);
    extern cl_int (CL_API_CALL *clGetDeviceInfo)(cl_device_id, cl_device_info, size_t, void *, size_t *);
    extern cl_context (CL_API_CALL *clCreateContext)(const cl_context_properties *, cl_uint, const cl_device_id *, void (CL_CALLBACK *)(const char *, const void *, size_t, void *), void *, cl_int *);
    extern cl_command_queue (CL_API_CALL *clCreateCommandQueue)(cl_context, cl_device_id, cl_command_queue_properties, cl_int *);
    extern cl_command_queue (CL_API_CALL *clCreateCommandQueueWithProperties)(cl_context, cl_device_id, const cl_queue_properties *, cl_int *);
    extern cl_mem (CL_API_CALL *clCreateBuffer)(cl_context, cl_mem_flags, size_t, void *, cl_int *);
    extern cl_mem (CL_API_CALL *clCreateBufferWithProperties)(cl_context, const cl_mem_properties *, cl_mem_flags, size_t, void *, cl_int *);
    extern cl_mem (CL_API_CALL *clCreateSubBuffer)(cl_mem, cl_mem_flags, cl_buffer_create_type, const void *, cl_int *);
    extern cl_mem (CL_API_CALL *clCreateImage)(cl_context, cl_mem_flags, const cl_image_format *, const cl_image_desc *, void *, cl_int *);
    extern cl_int (CL_API_CALL *clReleaseMemObject)(cl_mem);
    extern cl_int (CL_API_CALL *clGetMemObjectInfo)(cl_mem, cl_mem_info, size_t, void *, size_t *);
    extern cl_program (CL_API_CALL *clCreateProgramWithSource)(cl_context, cl_uint, const char **, const size_t *, cl_int *);
    extern cl_int (CL_API_CALL *clReleaseProgram)(cl_program);
    extern cl_int (CL_API_CALL *clBuildProgram)(cl_program, cl_uint, const cl_device_id *, const char *, void (CL_CALLBACK *)(cl_program, void *), void *);
    extern cl_int (CL_API_CALL *clGetProgramBuildInfo)(cl_program, cl_device_id, cl_program_build_info, size_t, void *, size_t *);
    extern cl_kernel (CL_API_CALL *clCreateKernel)(cl_program, const char *, cl_int *);
    extern cl_int (CL_API_CALL *clReleaseKernel)(cl_kernel);
    extern cl_int (CL_API_CALL *clSetKernelArg)(cl_kernel, cl_uint, size_t, const void *);
    extern cl_int (CL_API_CALL *clGetKernelInfo)(cl_kernel, cl_kernel_info, size_t, void *, size_t *);
    extern cl_int (CL_API_CALL *clGetKernelWorkGroupInfo)(cl_kernel, cl_device_id, cl_kernel_work_group_info, size_t, void *, size_t *);
    extern cl_int (CL_API_CALL *clGetKernelSubGroupInfo)(cl_kernel, cl_device_id, cl_kernel_sub_group_info, size_t, const void *, size_t, void *, size_t *);
    extern cl_int (CL_API_CALL *clEnqueueNDRangeKernel)(cl_command_queue, cl_kernel, cl_uint, const size_t *, const size_t *, const size_t *, cl_uint, const cl_event *, cl_event *);
    extern cl_int (CL_API_CALL *clEnqueueReadBuffer)(cl_command_queue, cl_mem, cl_bool, size_t, size_t, void *, cl_uint, const cl_event *, cl_event *);
    extern cl_int (CL_API_CALL *clEnqueueWriteBuffer)(cl_command_queue, cl_mem, cl_bool, size_t, size_t, const void *, cl_uint, const cl_event *, cl_event *);
    extern cl_int (CL_API_CALL *clEnqueueCopyBuffer)(cl_command_queue, cl_mem, cl_mem, size_t, size_t, size_t, cl_uint, const cl_event *, cl_event *);
    extern cl_int (CL_API_CALL *clEnqueueFillBuffer)(cl_command_queue, cl_mem, const void *, size_t, size_t, size_t, cl_uint, const cl_event *, cl_event *);
    extern void * (CL_API_CALL *clEnqueueMapBuffer)(cl_command_queue, cl_mem, cl_bool, cl_map_flags, size_t, size_t, cl_uint, const cl_event *, cl_event *, cl_int *);
    extern cl_int (CL_API_CALL *clEnqueueUnmapMemObject)(cl_command_queue, cl_mem, void *, cl_uint, const cl_event *, cl_event *);
    extern cl_int (CL_API_CALL *clEnqueueBarrierWithWaitList)(cl_command_queue, cl_uint, const cl_event *, cl_event *);
    extern cl_int (CL_API_CALL *clEnqueueMarkerWithWaitList)(cl_command_queue, cl_uint, const cl_event *, cl_event *);
    extern cl_int (CL_API_CALL *clFinish)(cl_command_queue);
    extern cl_int (CL_API_CALL *clFlush)(cl_command_queue);
    extern cl_int (CL_API_CALL *clReleaseContext)(cl_context);
    extern cl_int (CL_API_CALL *clReleaseCommandQueue)(cl_command_queue);
    extern cl_int (CL_API_CALL *clGetCommandQueueInfo)(cl_command_queue, cl_command_queue_info, size_t, void *, size_t *);
    extern cl_int (CL_API_CALL *clGetEventProfilingInfo)(cl_event, cl_profiling_info, size_t, void *, size_t *);
    extern cl_int (CL_API_CALL *clGetEventInfo)(cl_event, cl_event_info, size_t, void *, size_t *);
    extern cl_int (CL_API_CALL *clReleaseEvent)(cl_event);
    extern cl_int (CL_API_CALL *clWaitForEvents)(cl_uint, const cl_event *);
    extern cl_int (CL_API_CALL *clGetContextInfo)(cl_context, cl_context_info, size_t, void *, size_t *);
}

extern bool ggml_opencl_load_dynamic();
...
static ggml_backend_opencl_context * ggml_cl2_init(ggml_backend_dev_t dev) {
    const char * env_cl = getenv("GGML_OPENCL");
    if (env_cl && strcmp(env_cl, "0") == 0) {
        return NULL;
    }
    GGML_ASSERT(dev);
...
ggml_backend_t ggml_backend_opencl_init(void) {
    ...
    if (!ggml_opencl_load_dynamic()) {
        GGML_LOG_WARN("ggml_opencl: Failed to load libOpenCL.so. OpenCL backend unavailable.\n");
        return nullptr;
    }
...
extern "C" bool g_opencl_disabled;
...
ggml_backend_reg_t ggml_backend_opencl_reg(void) {
    ...
    // 🛡️ THE BLACK BOX: Dynamic Load Guard
    // Prevents SIGSEGV if libOpenCL.so is missing or corrupt during registry probing.
    if (!ggml_opencl_load_dynamic()) {
        return NULL;
    }
