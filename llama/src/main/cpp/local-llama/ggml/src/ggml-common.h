...
typedef struct {
    ...
    uint8_t    padding[60];            //  ADD THIS: Pad to 128 bytes (power-of-two) for Adreno stability
} block_turbo4_0;                       // 128 bytes total
static_assert(sizeof(block_turbo4_0) == 128, "wrong turbo4_0 block size");
#else
...
typedef struct {
    ...
    uint8_t    padding[60];            //  ADD THIS: Pad to 128 bytes total
} block_turbo4_0;                       // 128 bytes total
static_assert(sizeof(block_turbo4_0) == 128, "wrong turbo4_0 block size");
#endif
